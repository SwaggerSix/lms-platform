      ...
      >
        ...
        <defs>
          <linearGradient id="engagementGradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--brand-primary, #91C53C)" stopOpacity={0.2} />
            <stop offset="100%" stopColor="var(--brand-primary, #91C53C)" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <path
          d={linePath}
          fill="none"
          stroke="var(--brand-primary, #91C53C)"
          strokeWidth={2}
          strokeLinecap="round"
        ...
        {points.map((p, i) => (
          <g key={i}>
            <circle
              ...
              fill={hoveredIndex === i ? "var(--brand-primary, #91C53C)" : "white"}
              stroke="var(--brand-primary, #91C53C)"
              strokeWidth={2}
