      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            autoFocus
            placeholder="123456"
            className="block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-center font-mono text-lg tracking-[0.4em] text-gray-900 placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
          />
        </div>
