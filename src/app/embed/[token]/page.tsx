      ...
      <head>
        ...
        <style>{`
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .card { background: white; border-radius: 8px; padding: 12px 16px; margin-bottom: 8px; border: 1px solid #e5e7eb; border-left: 3px solid #91C53C; }
          ...
          .leader-rank { font-size: 14px; font-weight: 700; color: #91C53C; width: 30px; }
          ...
          .course-gradient { background: linear-gradient(135deg, #91C53C, #739E2D); padding: 24px; }
          ...
          .powered a { color: #91C53C; text-decoration: none; }
        `}</style>
      </head>
      <body>
            ...
            <>
              ...
              {(content as any[]).map((nugget: any) => (
                <div
                  key={nugget.id}
                  className="card"
                  style={{ borderLeftColor: typeColors[nugget.content_type]?.replace("border-l-", "") || "#91C53C" }}
                >
          ...
          {widget.widget_type === "progress_bar" && (
            <div className="card">
              ...
              <div style={{ marginTop: 8, height: 8, background: "#e5e7eb", borderRadius: 4, overflow: "hidden" }}>
                <div style={{ height: "100%", background: "#91C53C", borderRadius: 4, width: "0%" }} />
              </div>
            </div>
          )}
