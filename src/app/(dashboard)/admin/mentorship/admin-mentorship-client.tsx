...
export default function AdminMentorshipClient({
  ...
  const mentorColumns: DataTableColumn<any>[] = [
    {
      key: "mentor",
      header: "Mentor",
      sortValue: (mentor) => userName(mentor.user).toLowerCase(),
      render: (mentor) => (
        <div>
          <p className="text-sm font-medium text-gray-900">
            {mentor.user?.first_name} {mentor.user?.last_name}
          </p>
          <p className="text-xs text-gray-500">{mentor.user?.job_title || mentor.user?.email}</p>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (mentor) => (
        <span className="text-xs text-gray-600 capitalize">{mentor.availability || "-"}</span>
      ),
    },
    {
      key: "mentees",
      header: "Mentees",
      className: "text-center",
      sortValue: (mentor) => mentor.current_mentee_count ?? 0,
      render: (mentor) => (
    ...
    },
    {
      ...
      header: "Rating",
      className: "text-center",
      sortValue: (mentor) => (mentor.rating ? parseFloat(mentor.rating) : null),
      render: (mentor) => (
        <span className="text-sm text-gray-600">
  ...
  const requestColumns: DataTableColumn<any>[] = [
    {
      key: "mentee",
      header: "Mentee",
      sortValue: (req) => userName(req.mentee).toLowerCase(),
      render: (req) => (
        <div>
          <p className="text-sm font-medium text-gray-900">
    ...
    },
    {
      ...
      render: (req) =>
        req.mentor ? (
          <div>
            <p className="text-sm font-medium text-gray-900">
              {req.mentor.first_name} {req.mentor.last_name}
            </p>
    ...
    },
    {
      ...
      header: "Goals",
      render: (req) => (
        <p className="text-xs text-gray-500 max-w-[200px] truncate">{req.goals || "-"}</p>
      ),
    },
    {
      key: "created",
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 space-y-3">
        ...
        <DataTable
          ...
          emptyState={{
            ...
            title: "No mentor profiles yet",
            description: "Mentors appear here once users create a profile",
          }}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <DataTable
          ...
          rowKey={(req) => req.id}
          initialSort="-created"
          ariaLabel="Mentorship requests"
          emptyState={
            recentRequests.length === 0
              ? {
                  icon: <ClipboardList className="h-10 w-10" aria-hidden="true" />,
                  title: "No mentorship requests yet",
                  description: "Requests appear here when learners ask for a mentor",
                }
              : undefined
          }
        />
