  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        <Link href="/shop" className="hover:text-primary-600">Marketplace</Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Hero Image */}
          <div className="aspect-video bg-gradient-to-br from-primary-100 to-purple-100 rounded-xl overflow-hidden">
            {displayImage ? (
              <img
                src={displayImage}
                alt={displayTitle}
              ...
              <div className="w-full h-full flex items-center justify-center">
                <BookOpen className="w-20 h-20 text-primary-300" strokeWidth={1.5} />
              </div>
            )}
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="text-center py-8 text-gray-400">
              <Star className="w-12 h-12 mx-auto mb-3 text-gray-300" strokeWidth={1.5} />
